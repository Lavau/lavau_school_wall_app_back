...
public interface ObtainMyDataMapper {
    ...
    List<MixedDataModel> listObtainPublishedData(@Param("stuId") String stuId);
    ...
    List<MixedDataModel> listObtainLikedData(@Param("stuId") String stuId);
    ...
    List<MixedDataModel> listObtainCommentedData(@Param("stuId") String stuId);
}
